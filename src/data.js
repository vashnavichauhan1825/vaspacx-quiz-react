...
export const dummyQuiz = [{
  category:{
  quizId:uuidv4(),
  quizRules:["There are five questions in Quiz","you can choose only one option","4 marks for each Question","There is no negative marking","You can also skip the questions"],
  ...
  quiz :[ { 
    ...
    optionOne:"The Aphelion",
    optionTwo:"The Solstice",
    optionThree:"The Equinox",
    optionFour:"The Ecliptic",
    answer:"The Equinox"
},{ 
    id: uuidv4(),
    ...
    optionOne:"Saturn",
    optionTwo:"Neptune",
    optionThree:"90377 Sedna",
    optionFour:"Kuiper belt",
    answer:"Neptune"
},{ 
    id: uuidv4(),
    ...
    optionOne:"syzygy",
    optionTwo:"sizzle",
    optionThree:"symbology",
    optionFour:"suzerainty",
    answer:"syzygy"
},{ 
    id: uuidv4(),
    question:"Who invented the telescope ?",
    optionOne:"Johannes Kepler",
    optionTwo:"Galileo",
    optionThree:"Hypatia",
    optionFour:"Hans Lippershey",
    answer:"Galileo"
},{ 
    id: uuidv4(),
    question:"Which of these objects is the farthest from the Sun ?",
...
}]}},
{
 ...
 { category:{
    quizId:uuidv4(),
    quizRules:["There are seven questions in Quiz","you can choose only one option","4 marks for each Question","There is no negative marking","You can also skip the questions"],
